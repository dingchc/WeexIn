...
public class IncrementalResponseBody extends ResponseBody {
    ...
    private OkHttpAdapter.ResponseListener responseListener;

    public IncrementalResponseBody(ResponseBody realBody,OkHttpAdapter.ResponseListener responseListener){
